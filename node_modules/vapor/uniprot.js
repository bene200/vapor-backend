...
Uniprot.prototype.parse = function(file){
    ...
    //locus name
    locusName = file.match(/OrderedLocusNames=.{9}/g);
    if(locusName){
        locusName = locusName[0]
                .replace(/OrderedLocusNames=/g, "")
                .replace(/;/g, "")
                .trim();
        parsedInfo.locusname = locusName.toUpperCase();
    }
    else {
        parsedInfo.locusname = "";
    }
